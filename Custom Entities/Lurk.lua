...
local entityTable = Spawner.createEntity({
    ...
    Jumpscare = {
        true, -- Enabled/Disabled
        {
            Image1 = "rbxassetid://13007771402", -- Image1 url
    ...
    CustomDialog = {"Lurk is slow and can come around multiple times.", "Be careful when you get in and out of your hiding spot!"}, -- Custom death message
})
